          ...
          <div id="collapse_1" class="panel-wrapper collapse in">
            <div class="panel-body">
              <div class="row">
                ...
                {!! Form::model($news, array('route' => ['news.update', $news->id_news], 'method' => 'PUT', 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form')) !!}
                  @include('pages.master.news.form',array('submit' => 'Create'))
                {!! Form::close() !!}
