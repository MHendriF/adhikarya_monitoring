  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-group has-error">
        ...
        <div class="col-md-9">
          {!! Form::text('name_customer',null, array('class' => 'form-control', 'required', 'placeholder' => 'Nama Sesuai KTP')) !!}
      ...
      <div class="form-group">
        ...
        <div class="col-md-9">
          <div class='input-group date datetimepicker1'>
              @if(isset($customer))
                <input type='text' name="date_of_birth" class="form-control" value="{{$customer->date_of_birth}}" required/>
              @else
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-md-9">
            @if(isset($customer))
              <input type="password" class="form-control" name="password" value="{{$customer->password}}" readonly>
            @else
  ...
  <div class="row">
     <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-md-9">
          @if(isset($customer))
            <input type="file" name="image_path" id="input-file-now" class="dropify" data-default-file="{{ asset('/image_upload/customer/'.$customer->image_path) }}" value="{{$customer->image_path}}" />
          @else
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-md-9">
          {!! Form::text('profession',null, array('class' => 'form-control', 'placeholder' => 'xxxx')) !!}
        </div>
      </div>
    </div>
    <!--/span-->
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-md-9">
          {!! Form::text('phone',null, array('class' => 'form-control', 'placeholder' => 'xxxx')) !!}
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-md-9">
          {!! Form::number('income',null, array('class' => 'form-control', 'placeholder' => 'xxxx')) !!}
          <span class="help-block"> Pertahun </span>
        </div>
      </div>
    </div>
    <!--/span-->
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-md-9">
          {!! Form::textarea('note',null, array('class' => 'form-control', 'placeholder' => 'max.250 karakter')) !!}
        </div>
      </div>
    </div>
    <!--/span-->
