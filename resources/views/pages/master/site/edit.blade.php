              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-wrap">
                    ...
                    {!! Form::model($site, array('route' => ['site.update', $site->id_site], 'method' => 'PUT', 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form')) !!}
                      @include('pages.master.site.form',array('submit' => 'Create'))
                    {!! Form::close() !!}
