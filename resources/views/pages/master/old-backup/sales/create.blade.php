  ...
  <div class="container-fluid">
		...
		<div class="row heading-bg">
		  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h5 class="txt-dark">Sales Create</h5>
			</div>
			<!-- Breadcrumb -->
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-wrap">
                    ...
                    {!! Form::open(array('route' => 'sales.store', 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form')) !!}
                      @include('pages.master.sales.form',array('submit' => 'Create'))
                    {!! Form::close() !!}
