...
@section('title', 'Banner Slider Detail')
          ...
          <div id="collapse_1" class="panel-wrapper collapse in">
            <div class="panel-body">
              <div class="row">
                ...
                {!! Form::model($slider, array('class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form')) !!}
                            ...
                            <div class="panel-body">
                                <div class="form-wrap">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::text('url',null, array('class' => 'form-control', 'readonly')) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <div class='input-group date datetimepicker1'>
                                                @if(isset($slider))
                                                  <input type='text' name="expired_date" class="form-control" value="{{$slider->expired_date}}" readonly/>
                                                @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                          @if(isset($slider))
                                            <input name="image_path" type="file" id="input-file-now" class="dropify" data-default-file="{{ asset('/image_upload/slider/'.$slider->image_path) }}" value="{{$slider->image_path}}"/ readonly>
                                          @endif
                                        </div>
                                    </div>
                                    <div class="form-group">
