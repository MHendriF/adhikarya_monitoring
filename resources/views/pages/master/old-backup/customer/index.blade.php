      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-primary card-view">
          <div class="panel-heading">
            <div class="pull-left">
              <h4 class="panel-title txt-light"><strong>Filter Data Customer</strong></h4>
            </div>
      ...
      $(document).ready( function () {
          var oTable = $('#datatable').DataTable({
              ...
              "columns": [
                  ...
                  {data: 'name_customer'},
                  {data: 'email'},
                  {data: "image_path", "width":"60px", "render": function (data, type, full, meta) { return (data != null) ? '<img src="/image_upload/customer/'+ data +'" alt="no-logo" style="width:60%;height:auto">' : '<img src="assets/tema/ahsana/img/no-image.png" alt="no-logo" style="width:60%;height:auto">'; } },
                  {data: 'address_1'},
