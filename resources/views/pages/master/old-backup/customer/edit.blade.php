  ...
  <div class="container-fluid">
		...
		<div class="row heading-bg">
		  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h5 class="txt-dark">Customer Edit</h5>
			</div>
			<!-- Breadcrumb -->
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-wrap">
                    ...
                    {!! Form::model($customer, array('route' => ['customer.update', $customer->id_customer], 'method' => 'PUT', 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form')) !!}
                      @include('pages.master.customer.form',array('submit' => 'Update'))
                    {!! Form::close() !!}
