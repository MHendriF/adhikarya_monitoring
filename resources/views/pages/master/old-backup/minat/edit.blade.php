...
<div class="page-wrapper">
  <div class="container-fluid">
		...
		<div class="row heading-bg">
          ...
          <li><a href="{{ route('minat.index') }}"><span>Minat</span></a></li>
		...
		<div class="row">
          ...
          <div class="panel-heading">
  					<div class="pull-left">
  						<h6 class="panel-title txt-light"><i class="fa fa-map-marker"></i>&nbsp;&nbsp;Form Minat</h6>
  					</div>
          ...
          <div id="collapse_1" class="panel-wrapper collapse in">
            <div class="panel-body">
              <div class="row">
                <center>
                  <h3 style="padding-top: 1em">Minat</h3>
                </center>

                {!! Form::model($minat, array('route' => ['minat.update', $minat->id_minat], 'method' => 'PUT', 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form')) !!}
                  @include('pages.master.minat.form',array('submit' => 'Update'))
                {!! Form::close() !!}
