  ...
  <div class="container-fluid">
		...
		<div class="row heading-bg">
		  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h5 class="txt-dark">Inbox Edit</h5>
			</div>
			<!-- Breadcrumb -->
          ...
          <div id="collapse_1" class="panel-wrapper collapse in">
            <div class="panel-body">
              <div class="row">
                ...
                {!! Form::model($support, array('route' => ['inbox.update', $support->id_support], 'method' => 'PUT', 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form')) !!}
                  @include('pages.master.inbox.form',array('submit' => 'Update'))
                {!! Form::close() !!}
