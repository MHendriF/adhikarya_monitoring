  ...
  <div class="container-fluid">
		...
		<div class="row heading-bg">
		  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h5 class="txt-dark">Unit Create</h5>
			</div>
			<!-- Breadcrumb -->
        ...
        <div class="panel panel-default card-view">
          <div class="panel-heading">
            <div class="pull-left">
              ...
              <h5><strong>Total UNIT Site ini : {{$site->total_unit}}/{{$site->kuota_unit}}</strong></h5>
            </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-wrap">
                    ...
                    {!! Form::open(array('route' => 'unit.store', 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form')) !!}
