              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-wrap">
                    ...
                    {!! Form::model($user, array('route' => ['user.update', $user->id_user], 'method' => 'PUT', 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form')) !!}
                      @include('pages.master.user.form',array('submit' => 'Update'))
                    {!! Form::close() !!}
