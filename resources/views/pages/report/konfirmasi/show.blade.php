  ...
  <div class="container-fluid">
		...
		<div class="row heading-bg">
		  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h5 class="txt-dark">Payment @if($invoice[0]->cicilan_ke == 'DP')
                                      DP
                                     @else
          ...
          <li><a href="{{ route('invoice.index') }}"><span>Payment</span></a></li>
          <li class="active"><span>Konfirmasi</span></li>
				</ol>
			</div>
			<!-- /Breadcrumb -->
		</div>
           ...
           <div class="panel-body">
             ...
             <div class="invoice-bill-table">
               ...
               <div class="row">
                 <div class="col-md-12">
                   <div class="form-wrap">
                     {!! Form::model($invoice, array('route' => ['konfirmasi.approved',  $invoice[0]->id_payment], 'method' => 'PUT', 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form')) !!}
                       <div class="form-body">
                           ...
                           <div class="row">
                             <div class="col-md-6">
                               <div class="form-group  ">
                                 ...
                                 <div class="col-md-9">
                                     <!-- <input type="text" class="form-control" placeholder="10/01/19 10:22:20" disabled> -->
                                   <div class='input-group date datetimepicker1'>
                                     <input type='text' name="confirmation_date" class="form-control" required/>
                             ...
                             <div class="col-md-6">
                               <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                   {!! Form::number('paid_off',null, array('class' => 'form-control', 'required', 'placeholder' => '1.900.000')) !!}
                                 </div>
                               </div>
                             </div>
                             <!--/span-->
                             ...
                             <div class="col-md-6">
                               <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                   {!! Form::textarea('note',null, array('class' => 'form-control', 'required', 'placeholder' => 'catatan terkait konfirmasi pembayaran ...', 'rows'=>'3')) !!}
                                 </div>
                               </div>
                             </div>
                             <!--/span-->
                             ...
                             <div class="col-md-6">
                               <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                   {!! Form::textarea('message',$invoice[0]->message, array('class' => 'form-control', 'readonly', 'rows'=>'3')) !!}
                                 </div>
                               </div>
                             </div>
                             <!--/span-->
                              <div class="col-md-6">
                               <div class="form-group">
                                 ...
                                 <div class="col-md-9">
                                   @if(isset($invoice[0]->image_path))
                                       <a href="{{url('image_upload/payment/'.$invoice[0]->image_path)}}" target="_blank">
                                       <img src="{{url('image_upload/payment/'.$invoice[0]->image_path)}}" width="130px"></a>
                                   @else
                       ...
                       <div class="pull-right">
                         <button type="submit" data-toggle="tooltip" class="btn btn-success mr-10">
 													Konfirmasi Full
 												 </button>
 												 <button type="submit"  data-toggle="tooltip" class="btn btn-danger mr-10">
