...
<div class="page-wrapper">
  <div class="container-fluid">
		...
		<div class="row heading-bg">
          ...
          <li><a href="{{ route('hse.index') }}"><span>{{ $submenu }}</span></a></li>
          ...
          <div id="collapse_1" class="panel-wrapper collapse in">
            <div class="panel-body">
              <div class="row">
                ...
                {!! Form::open(array('route' => 'hse.store', 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form')) !!}
                  @include('pages.document.hse.form',array('submit' => 'Create'))
                {!! Form::close() !!}
