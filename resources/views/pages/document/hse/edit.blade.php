          ...
          <div id="collapse_1" class="panel-wrapper collapse in">
            <div class="panel-body">
              <div class="row">
                ...
                {!! Form::model($dokumen, array('route' => ['hse.update', $dokumen->id_dokumen], 'method' => 'PUT', 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form')) !!}
                  @include('pages.document.hse.form',array('submit' => 'Update'))
                {!! Form::close() !!}
