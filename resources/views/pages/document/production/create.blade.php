...
@section('title', 'Engineering Document Create')
  ...
  <div class="container-fluid">
		...
		<div class="row heading-bg">
		  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h5 class="txt-dark">Engineering Document Create</h5>
			</div>
			<!-- Breadcrumb -->
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<ol class="breadcrumb">
          <li><a href="{{ route('dashboard') }}"><i class="fa fa-home"></i>&nbsp;Dashboard</a></li>
          <li><a href="{{ route('production.index') }}"><span>{{ $submenu }}</span></a></li>
          ...
          <div id="collapse_1" class="panel-wrapper collapse in">
            <div class="panel-body">
              <div class="row">
                ...
                {!! Form::open(array('route' => 'production.store', 'method' => 'POST', 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form')) !!}
                  @include('pages.document.production.form',array('submit' => 'Create'))
                {!! Form::close() !!}
