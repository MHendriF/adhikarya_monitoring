...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('user')->insert(array(
           ...
           array('username'=>'user1', 'email'=>'admin@adikarya.co.id', 'password'=>bcrypt('zxcasd123'), 'nama_user'=>'User1', 'id_jabatan'=>'10', 'id_divisi'=>'1', 'id_lembaga'=>'5', 'created_at'=>$today, 'updated_at'=>$today),
        ));
    }
}
